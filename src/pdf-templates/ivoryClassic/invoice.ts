      ...
      <tr>
        ...
        <td style="width:45%; vertical-align:top;">
          ...
          <table style="width:100%; border-collapse:collapse; margin-top:10px;" cellpadding="0" cellspacing="0">
            <tr>
              <td style="font-size:17px; font-weight:700; text-transform:uppercase; color:#2B2118; padding:10px 0; border-top:3px double #A67C3D; border-bottom:3px double #A67C3D;">Total Amount Due:</td>
