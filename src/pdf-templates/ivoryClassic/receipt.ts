  ...
  <div style="width:210mm; margin:0 auto; padding:15mm; box-sizing:border-box; font-family:Georgia,'Times New Roman',Times,serif; background-color:#FBF3DF; color:#2B2118;">
    ...
    <div style="text-align:center; margin-top:10px; padding-bottom:10px; border-bottom:1px solid #A67C3D;">
      <span style="font-size:12px; text-transform:uppercase; letter-spacing:1px; color:#2B2118;">
        RECEIPT NO: {{document_number}} &nbsp;&nbsp;|&nbsp;&nbsp; PAYMENT DATE: {{paid_date}}
      </span>
    </div>

    <div style="margin-top:20px; text-align:left;">
      <div style="font-size:12px; font-weight:700; letter-spacing:1px; text-transform:uppercase; color:#2B2118; margin-bottom:6px;">Received From</div>
    ...
    <table style="width:100%; border-collapse:collapse; margin-top:20px;" cellpadding="0" cellspacing="0">
      <tr>
        <td style="width:80px; vertical-align:middle;">
          <div style="width:80px; height:80px; border-radius:50%; border:3px solid #16A34A; display:table-cell; text-align:center; vertical-align:middle; transform:rotate(-10deg); color:#16A34A; font-weight:700; font-size:14px; letter-spacing:2px;">PAID</div>
        </td>
        <td style="vertical-align:middle; padding-left:20px;">
          <div style="border:2px solid #A67C3D; padding:16px; text-align:center;">
            <div style="font-size:28px; font-weight:700; color:#2B2118;">Amount Paid: {{currency}}{{total_amount}}</div>
            <div style="font-size:13px; color:#2B2118; margin-top:8px;">
              Payment Method: {{payment_method}} &nbsp;&nbsp;|&nbsp;&nbsp; Ref: {{payment_reference}}
            </div>
          </div>
        </td>
      </tr>
    ...
    <div style="text-align:center;">
      <div style="font-size:13px; font-style:italic; color:#2B2118; line-height:1.7;">
        {{terms}}<br/>
        {{notes}}
      </div>
      <div style="margin-top:14px;">{{bank_details_block}}</div>
      <div style="font-size:13px; font-style:italic; color:#2B2118; margin-top:14px;">Thank you for your business</div>
    </div>
